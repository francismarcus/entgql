...
func (pq *ProgramQuery) QueryCreator() *UserQuery {
	...
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		...
		step := sqlgraph.NewStep(
			sqlgraph.From(program.Table, program.FieldID, pq.sqlQuery()),
...
func (pq *ProgramQuery) WithCreator(opts ...func(*UserQuery)) *ProgramQuery {
	query := &UserQuery{config: pq.config}
